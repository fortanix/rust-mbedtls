...
pub const PLATFORM_DEFINES: &'static [(&'static str, &'static str, CDefine)] = &[
    ...
    ("tls_support",  "tls13",    ("MBEDTLS_PSA_CRYPTO_C",                                       Defined)),
    ("tls_support",  "tls13",    ("MBEDTLS_SSL_PROTO_TLS1_3",                                   Defined)),
    ("tls_support",  "tls13",    ("MBEDTLS_SSL_TLS1_3_COMPATIBILITY_MODE",                      Defined)),
    ("tls_support",  "tls13",    ("MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_PSK_ENABLED",           Defined)),
    ("tls_support",  "tls13",    ("MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_EPHEMERAL_ENABLED",     Defined)),
    ("tls_support",  "tls13",    ("MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_PSK_EPHEMERAL_ENABLED", Defined)),
    ("tls_support",  "tls13",    ("MBEDTLS_SSL_TLS1_3_TICKET_AGE_TOLERANCE",                    DefinedAs("6000"))),
    ("tls_support",  "tls13",    ("MBEDTLS_SSL_TLS1_3_TICKET_NONCE_LENGTH",                     DefinedAs("32"))),
    ("tls_support",  "tls13",    ("MBEDTLS_SSL_TLS1_3_DEFAULT_NEW_SESSION_TICKETS",             DefinedAs("1"))),
    ("tls_support",  "external_entropy",    ("MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG",                 Defined)),
];
