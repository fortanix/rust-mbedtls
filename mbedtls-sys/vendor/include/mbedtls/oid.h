...
#define MBEDTLS_OID_THAWTE                      MBEDTLS_OID_ISO_IDENTIFIED_ORG MBEDTLS_OID_ORG_THAWTE
...
/**
 * \brief          Translate Algorithm Identifier OID into an EC group identifier
 *
 * \param oid      OID to use
 * \param grp_id   place to store group id
 *
...
/**
 * \brief          Translate EC group identifier into Algorithm Identifier OID
 *
 * \param grp_id   EC group identifier
 * \param oid      place to store ASN.1 OID string pointer
 * \param olen     length of the OID
