...
mod is_prime_tests {
    ...
    fn test_is_prime(input: Mpi, prime_expected: bool) {
        ...
        let mut rng = CtrDrbg::new(Rdseed.into(), None).expect("create CtrDrbg");
    ...
    #[rstest]
    #[case::negative_4(Mpi::new(-4).unwrap(), false)]
    #[case::negative_3(Mpi::new(-3).unwrap(), true)]
    #[case::negative_2(Mpi::new(-2).unwrap(), true)]
    #[case::negative_1(Mpi::new(-1).unwrap(), false)]
    #[case::zero(Mpi::new(0).unwrap(), false)]
    #[case::positive_1(Mpi::new(1).unwrap(), false)]
    #[case::positive_2(Mpi::new(2).unwrap(), true)]
    #[case::positive_3(Mpi::new(3).unwrap(), true)]
    #[case::positive_4(Mpi::new(4).unwrap(), false)]
    #[case::last_prime_before_10000_9973(Mpi::new(9973).unwrap(), true)]
    #[case::first_prime_before_10000_10007(Mpi::new(10007).unwrap(), true)]
    #[case::positive_10009(Mpi::new(10009).unwrap(), true)]
    #[case::the_1000000000th_prime_22801763489(Mpi::new(22801763489).unwrap(), true)]
    #[case::positive_22801763491(Mpi::new(22801763491).unwrap(), false)]
    #[case::rsa_250_p(Mpi::from_binary(RSA_250_P).unwrap(), true)]
    #[case::rsa_250_q(Mpi::from_binary(RSA_250_Q).unwrap(), true)]
    #[case::rsa_250_n(Mpi::from_binary(RSA_250_N).unwrap(), false)]
    fn is_probably_prime(#[case] input: Mpi, #[case] prime_expected: bool) {
        test_is_prime(input, prime_expected);
    }
}
