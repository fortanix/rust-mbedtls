...
error_enum!(
    ...
    enum HiError {
        ...
        Pkcs7AllocFailed = ERR_PKCS7_ALLOC_FAILED,
        Pkcs7BadInputData = ERR_PKCS7_BAD_INPUT_DATA,
        Pkcs7CertDateInvalid = ERR_PKCS7_CERT_DATE_INVALID,
        Pkcs7FeatureUnavailable = ERR_PKCS7_FEATURE_UNAVAILABLE,
        Pkcs7InvalidAlg = ERR_PKCS7_INVALID_ALG,
        Pkcs7InvalidCert = ERR_PKCS7_INVALID_CERT,
        Pkcs7InvalidContentInfo = ERR_PKCS7_INVALID_CONTENT_INFO,
        Pkcs7InvalidFormat = ERR_PKCS7_INVALID_FORMAT,
        Pkcs7InvalidSignature = ERR_PKCS7_INVALID_SIGNATURE,
        Pkcs7InvalidSignerInfo = ERR_PKCS7_INVALID_SIGNER_INFO,
        Pkcs7InvalidVersion = ERR_PKCS7_INVALID_VERSION,
        Pkcs7VerifyFail = ERR_PKCS7_VERIFY_FAIL,
