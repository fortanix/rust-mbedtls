...
impl DsaParams {
    pub fn from_params(p: Mpi, q: Mpi, g: Mpi) -> Result<Self> {
        ...
        // FIPS 186-4 requires one of these parameter sets
        match (p_bits, q_bits) {
            (2048, 224) => Ok(Self { p, q, g }),
            (2048, 256) => Ok(Self { p, q, g }),
            (3072, 256) => Ok(Self { p, q, g }),
            (_,_) => Err(Error::PkBadInputData)
        }
    }

    pub fn hardcoded_2048_256() -> Result<Self> {
        // Randomly generated by OpenSSL
        Ok(Self {
            p: Mpi::from_str("")?,
            q: Mpi::from_str("0xC461FA60DCCBC684AD5249C114D5470B74B41CFFD058C924EC5B585AA27E9825")?,
            g: Mpi::from_str("")?
        })
    }
}
...
impl DsaPublicKey {
    ...
    pub fn from_params(params: DsaParams, y: Mpi) -> Result<Self> {
        Ok(Self { params, y })
    }
    ...
    pub fn from_der(der: &[u8]) -> Result<Self> {
        ...
        let params = DsaParams::from_params(p, q, g)?;

        DsaPublicKey::from_params(params, y)
    }
...
impl DsaPrivateKey {
    pub fn from_params(params: DsaParams, x: Mpi) -> Result<Self> {
        Ok(Self { params, x })
    }
    ...
    pub fn from_der(der: &[u8]) -> Result<Self> {
        ...
        DsaPrivateKey::from_params(params, x)
    }
    ...
    pub fn public_key(&self) -> Result<DsaPublicKey> {
        ...
        DsaPublicKey::from_params(self.params.clone(), y)
    }
...
mod tests {
    ...
    #[test]
    fn dsa_der() {
        let params = DsaParams::hardcoded_2048_256().unwrap();
    ...
    fn dsa_out_of_range_signatures() {
        ...
        let pubkey = DsaPublicKey::from_params(params, y).unwrap();
