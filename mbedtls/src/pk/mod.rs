...
impl Pk {
    ...
    pub fn generate_rsa<F: Random>(rng: &mut F, bits: u32, exponent: u32) -> Result<Pk> {
        ...
        unsafe {
            ...
            rsa_gen_key(ret.inner.pk_ctx as *mut _, Some(F::call), rng.data_ptr(), bits, exponent as _).into_result()?;
        }
        Ok(ret)
    }
...
Please use `private_from_ec_scalar_with_rng` instead."
    ...
    pub fn verify(&mut self, md: MdType, hash: &[u8], sig: &[u8]) -> Result<()> {
        ...
        unsafe {
            pk_verify(&mut self.inner, md.into(), hash.as_ptr(), hash.len(), sig.as_ptr(), sig.len())
                .into_result()
                .map(|_| ())
        }
    }
    ...
    pub fn write_private_der_vec(&mut self) -> Result<Vec<u8>> {
        crate::private::alloc_vec_repeat(|buf, size| unsafe { pk_write_key_der(&mut self.inner, buf, size) }, true)
    }
    ...
    pub fn write_public_der_vec(&mut self) -> Result<Vec<u8>> {
        crate::private::alloc_vec_repeat(|buf, size| unsafe { pk_write_pubkey_der(&mut self.inner, buf, size) }, true)
    }
...
\0";
    ...
    const TEST_DER: &'static [u8] = &[
        ,
    ];
    ...
    fn generate_ec_curve25519() {
        let _generated = Pk::generate_ec(&mut crate::test_support::rand::test_rng(), EcGroupId::Curve25519).unwrap();
        // mbedtls does not have an OID for Curve25519, so can't write it as PEM
    }

    #[test]
    fn generate_ec_secp192r1() {
        let _generated = Pk::generate_ec(&mut crate::test_support::rand::test_rng(), EcGroupId::SecP192R1)
            .unwrap()
    ...
    fn generate_ec_secp256r1() {
        ...
        let mut pub2 = Pk::public_from_ec_components(secp256r1.clone(), key1.ec_public().unwrap()).unwrap();
    ...
    fn generate_ec_secp256k1() {
        let _generated = Pk::generate_ec(&mut crate::test_support::rand::test_rng(), EcGroupId::SecP256K1)
            .unwrap()
            .write_private_pem_string()
            .unwrap();
    }
    ...
    fn rsa_sign_verify_pkcs1v15() {
        ...
        for &digest in &digests {
            ...
            let len = pk
                .sign(digest, data, &mut signature, &mut crate::test_support::rand::test_rng())
                .unwrap();
    ...
    fn encrypt_raw_decrypt_with_pkcs1_v15() {
        ...
        assert_eq!(pk.encrypt(b"test", &mut cipher, &mut rng).unwrap(), cipher.len());
    ...
    fn rsa_encrypt_decrypt_with_label() {
        ...
        let cipher_len = pk
            .encrypt_with_label(plain, &mut cipher, &mut crate::test_support::rand::test_rng(), b"MY_LABEL")
            .unwrap();
