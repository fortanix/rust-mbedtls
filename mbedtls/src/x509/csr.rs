...
impl fmt::Debug for Csr {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match alloc_string_repeat(|buf, size| unsafe { x509_csr_info(buf, size, b"\0".as_ptr() as *const _, &self.inner) }) {
            Err(_) => Err(fmt::Error),
            Ok(s) => f.write_str(&s),
        }
    }
...
impl<'a> Builder<'a> {
    ...
    pub fn extension(&mut self, oid: &[u8], val: &[u8]) -> Result<&mut Self> {
        unsafe { x509write_csr_set_extension(&mut self.inner, oid.as_ptr() as *const _, oid.len(), val.as_ptr(), val.len()) }
            .into_result()?;
        Ok(self)
    }
    ...
    pub fn write_der_vec<F: Random>(&mut self, rng: &mut F) -> Result<Vec<u8>> {
        alloc_vec_repeat(
            |buf, size| unsafe { x509write_csr_der(&mut self.inner, buf, size, Some(F::call), rng.data_ptr()) },
            true,
        )
    }
...
";
    ...
    const TEST_DER: &'static [u8] = &[
        0x30, 0x82, 0x02, 0x5f, 0x30, 0x82, 0x01, 0x47, 0x02, 0x01, 0x00, 0x30, 0x1a, 0x31, 0x18, 0x30, 0x16, 0x06, 0x03, 0x55,
        ...
        ,
